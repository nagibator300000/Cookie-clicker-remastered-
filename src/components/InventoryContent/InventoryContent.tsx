import { MouseEventHandler, ReactNode, useRef, type CSSProperties } from 'react'
...
const CONTENT_INFO: ContentInfo = {
    ...
    quick_slash: {
        ...
        description: (
            <>
                <div>
                    Born from imperfect, discarded nails that have fused
                    together
                </div>
                <br />
                <div>
                    The nails still long to be wielded. Allows the bearer to
    ...
    fury_of_the_fallen: {
        ...
        description: (
            <>
                <div>
                    Embodies the fury and heroism that comes upon those who are
                    about to die
                </div>
                <br />
                <div>
    ...
    spell_twister: {
        ...
        description: (
            <>
                <div>
                    Reflecting the desires of the Soul Sanctum for mastery over
                    SOUL, it improves the bearer's ability to cast spells
                </div>
                <br />
    ...
    soul_catcher: {
        ...
        description: (
            <>
                ...
                <br />
                <div>
                    Increases the amount of SOUL gained when striking an enemy
                    with the nail
                </div>
            </>
        ),
    ...
    soul_eater: {
        ...
        description: (
            <>
                <div>
                    Forgotten shaman artifact, used to draw SOUL from
                    still-living creatures
                </div>
                <br />
                <div>
                    Greatly increases the amount of SOUL gained when striking an
                    enemy with the nail
                </div>
            </>
        ),
